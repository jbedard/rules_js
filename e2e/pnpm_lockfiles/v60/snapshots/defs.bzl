...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_types_estree__registry.npmjs.org_at_types_estree_0.0.39__links//:defs.bzl", store_15 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_types_sizzle__registry.npmjs.org_at_types_sizzle_2.3.8__links//:defs.bzl", link_19 = "npm_link_imported_package_store", store_19 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__is-core-module__2.15.0__links//:defs.bzl", store_33 = "npm_imported_package_store")
