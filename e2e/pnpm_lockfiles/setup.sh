...
pushd base && npx pnpm@8.5.1 install --lockfile-only && npx pnpm@8.5.1 upgrade --lockfile-only @types/sizzle && mv pnpm-lock.yaml ../v60/ && popd
pushd base && npx pnpm@8.6.0 install --lockfile-only && npx pnpm@8.6.0 upgrade --lockfile-only @types/sizzle && mv pnpm-lock.yaml ../v61/ && popd
