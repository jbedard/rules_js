...
=======
            ...
            deps = {
                ...
                "//<LOCKVERSION>:.aspect_rules_js/{}/@scoped+c@file_..+projects+c_@scoped+b@projects+b".format(name): "@scoped/c",
                "//<LOCKVERSION>:.aspect_rules_js/{}/hello@https_+gitpkg.vercel.app+EqualMa+gitpkg-hello+packages+hello".format(name): "hello",
                "//<LOCKVERSION>:.aspect_rules_js/{}/@foo+jsonify@https_+github.com+aspect-build+test-packages+releases+download+0.0.0+@foo-jsonify-0.0.0.tgz".format(name): "jsonify",
            },
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
...
>>>>>>> f3b95145 (test: peer dependencies with different version specifiers)
